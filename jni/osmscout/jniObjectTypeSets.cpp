...
extern "C" {
   ...
   jint
   Java_osm_scout_ObjectTypeSets_jniConstructor(JNIEnv *env, jobject object) {
   ...
   void
   Java_osm_scout_ObjectTypeSets_jniDestructor(JNIEnv *env, jobject object,
	 int objectTypeSetsIndex) {
      ObjectTypeSets *nativeObjectTypeSets = gObjectTypeSetsArray->GetAndRemove(
	    objectTypeSetsIndex);
