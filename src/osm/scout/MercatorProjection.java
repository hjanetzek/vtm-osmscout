...
public class MercatorProjection extends Projection {
	...
	public boolean set(double minLon, double minLat, double maxLon, double maxLat,
		...
		return jniSetBounds(mJniProjectionIndex, mLon, mLat, maxLon, maxLat, mMagnification,
		                    mWidth);
	}
	...
	protected native boolean jniSetBounds(int jniProjectionIndex,
	                                      double lon, double lat, double maxLon, double maxLat,
	                                      double magnification,
	                                      int width);
