...
public abstract class Projection {
	...
	protected double mLon = 0.0; // ! Longitude coordinate of the center of the
								 // image
	protected double mLat = 0.0; // ! Latitude coordinate of the center of the
								 // image
	...
	public static int lat2tiley(double lat, long zoom) {
		...
		return (int) Math.floor((1.0 - Math.log(Math.tan(lat * Math.PI / 180.0) + 1.0
